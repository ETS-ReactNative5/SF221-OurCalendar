        ...
        return (
            <DrawerContentScrollView {...this.props} safeArea onLayout={(e) => this.onLayout(e)} style={{backgroundColor:"#f2efe7"}}>
                <Box height={this.state.height - 67}>
                    ...
                    <NavAppBox iconFont="MaterialCommunityIcons" colorText="#000000" icon="calendar-multiple" background={this.backgroundColor(2)} border={this.borderColor(2)} colorIcon="#000000" text={t('side_nav.calendar_team')} onPress={() => this.props.team.team ? navigation.navigate('CalendarTeam') : null}/>
